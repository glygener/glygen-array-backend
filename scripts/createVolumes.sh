...
mkdir $HOME/$SITE_CODE/log/logs
mkdir $HOME/$SITE_CODE/log/data
...
mkdir $HOME/$SITE_CODE/jenkins/jenkins_home
...
mkdir $HOME/$SITE_CODE/postgres/log
mkdir $HOME/$SITE_CODE/postgres/data
