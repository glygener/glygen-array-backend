...
import org.glygen.array.view.FeedbackView;
...
public class UtilityController {
    ...
    public Confirmation saveFeedback (
            ...
            @RequestBody FeedbackView feedback) {
        ...
        if (feedback.getSubject() == null || feedback.getSubject().isEmpty()) {
            errorMessage.addError(new ObjectError ("subject", "NoEmpty"));
        }
        ...
        if (feedback.getWebsite() != null && !feedback.getWebsite().isEmpty()) {
        	...
        	return new Confirmation ("Feedback is not valid, ignored", HttpStatus.OK.value());
        }
